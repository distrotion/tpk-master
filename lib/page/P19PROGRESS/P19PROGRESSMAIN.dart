...
import '../page26.dart';
import '../page8.dart';
import 'P19PROGRESSVAR.dart';

class P19PROGRESSMAIN extends StatefulWidget {
  P19PROGRESSMAIN({
    super.key,
    this.data,
  });
  ...
  @override
  State<P19PROGRESSMAIN> createState() => _P19PROGRESSMAINState();
}

class _P19PROGRESSMAINState extends State<P19PROGRESSMAIN> {
  @override
  void initState() {
    super.initState();
                          ...
                          Wrap(
                            ...
                            children: [
                              MouseRegion(
                                onEnter: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM1 = true;
                                  });
                                },
                                onExit: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM1 = false;
                                  });
                                },
                                child: Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      height: P19PROGRESSVAR.isHoveredPM1
                                          ? 170
                                          : 150,
                                      width: P19PROGRESSVAR.isHoveredPM1
                                          ? 170
                                          : 150,
                              ...
                              MouseRegion(
                                onEnter: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM2 = true;
                                  });
                                },
                                onExit: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM2 = false;
                                  });
                                },
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: InkWell(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      height: P19PROGRESSVAR.isHoveredPM2
                                          ? 170
                                          : 150,
                                      width: P19PROGRESSVAR.isHoveredPM2
                                          ? 170
                                          : 150,
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(
                              ...
                              MouseRegion(
                                onEnter: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM3 = true;
                                  });
                                },
                                onExit: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM3 = false;
                                  });
                                },
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: InkWell(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      height: P19PROGRESSVAR.isHoveredPM3
                                          ? 170
                                          : 150,
                                      width: P19PROGRESSVAR.isHoveredPM3
                                          ? 170
                                          : 150,
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(
                              ...
                              MouseRegion(
                                onEnter: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM4 = true;
                                  });
                                },
                                onExit: (_) {
                                  setState(() {
                                    P19PROGRESSVAR.isHoveredPM4 = false;
                                  });
                                },
                                child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: InkWell(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      height: P19PROGRESSVAR.isHoveredPM4
                                          ? 170
                                          : 150,
                                      width: P19PROGRESSVAR.isHoveredPM4
                                          ? 170
                                          : 150,
                                      decoration: BoxDecoration(
                                        gradient: LinearGradient(
