...
class ComInputTextTan extends StatefulWidget {
  ComInputTextTan({
    Key? key,
    this.sValue = "",
    this.nId = 0,
  ...
  @override
  _ComInputTextTanState createState() => _ComInputTextTanState();
}

class _ComInputTextTanState extends State<ComInputTextTan> {
